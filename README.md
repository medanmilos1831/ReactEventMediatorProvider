...
```sh
npx nx serve react-event-mediator-provider
```

To create a production bundle:

```sh
npx nx build react-event-mediator-provider
```

To see all available targets to run for a project, run:

```sh
npx nx show project react-event-mediator-provider
```
